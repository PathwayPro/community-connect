...
async function collectProjectsAndTestFiles(testRun, additionalFileMatcher) {
  ...
  for (const [project, type] of projectClosure) {
    ...
    if (type === 'top-level') project.project.repeatEach = (_project$fullConfig$c = project.fullConfig.configCLIOverrides.repeatEach) !== null && _project$fullConfig$c !== void 0 ? _project$fullConfig$c : project.project.repeatEach;
  }
