...
class SnapshotHelper {
  ...
  handleMissing(actual) {
    ...
    if (isWriteMissingMode) {
      ...
      this.testInfo.attachments.push({
        name: addSuffixToFilePath(this.snapshotName, '-actual'),
  ...
  handleDifferent(actual, expected, previous, diff, diffError, log, title = `${this.kind} comparison failed:`) {
    ...
    if (expected !== undefined) {
      ...
      this.testInfo.attachments.push({
        name: addSuffixToFilePath(this.snapshotName, '-expected'),
        contentType: this.mimeType,
    ...
    if (previous !== undefined) {
      ...
      this.testInfo.attachments.push({
        name: addSuffixToFilePath(this.snapshotName, '-previous'),
        contentType: this.mimeType,
    ...
    if (diff !== undefined) {
      ...
      this.testInfo.attachments.push({
        name: addSuffixToFilePath(this.snapshotName, '-diff'),
        contentType: this.mimeType,
        path: this.diffPath
      });
...
function addSuffixToFilePath(filePath, suffix, customExtension, sanitize = false) {
  ...
  const sanitizeForSnapshotFilePath = s => {
