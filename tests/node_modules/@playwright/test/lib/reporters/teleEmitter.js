...
class TeleReporterEmitter {
  ...
  _serializeConfig(config) {
    ...
    return {
      ...
      listOnly: (_FullConfigInternal$f = _config.FullConfigInternal.from(config)) === null || _FullConfigInternal$f === void 0 ? void 0 : _FullConfigInternal$f.cliListOnly
    };
  }
  _serializeProject(suite) {
    const project = suite.project();
    const report = {
      id: _config.FullProjectInternal.from(project).id,
