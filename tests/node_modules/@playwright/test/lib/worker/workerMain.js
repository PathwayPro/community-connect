...
class WorkerMain extends _process.ProcessRunner {
  ...
  _stop() {
    if (!this._isStopped) {
      ...
      (_this$_currentTest = this._currentTest) === null || _this$_currentTest === void 0 ? void 0 : _this$_currentTest._interrupt();
    }
  ...
  async _runTest(test, retry, nextTest) {
    ...
    if (!preserveOutput) await removeFolderAsync(testInfo.outputDir).catch(() => {});
  }
